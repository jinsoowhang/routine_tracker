...
class cleanChaseData():


    def cleaning_chase_credit_card_data(self, file_name, card_owner, output_file_name):
        ...
        clean_data = bank_df.copy()


        # Column name change
        clean_data.columns = ['Date', 'Post Date', 'Supplier', 'Category', 'Type', 'Amount', 'Memo']
        ...
        clean_data = clean_data[['Date', 'Supplier', 'Category', 'Type', 'Amount', 'Memo']]
        ...
        # print(final_df[final_df['transaction_type'] == 'purchase'])
        # print(final_df)
